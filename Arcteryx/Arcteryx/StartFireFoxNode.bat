...
REM work set DriverPath=D:\WorkSpace\Github\Arcteryx\packages\Selenium.Firefox.WebDriver.0.24.0\driver

set ServerPath=F:\Selenium\Git\Arcteryx\Arcteryx\packages\selenium-server-standalone.3.9.1.1\jar
set DriverPath=F:\Selenium\Git\Arcteryx\Arcteryx\packages\Selenium.Firefox.WebDriver.0.24.0\driver
